...
export const products = pgTable("products", {
  ...
  image: text("image"), // Legacy field for backward compatibility
  images: text("images"), // JSON string containing image variants and URLs
  imageVariants: text("image_variants"), // JSON string with all image variants metadata
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
});
...
// Customers table (for anonymous users, now links to users)
